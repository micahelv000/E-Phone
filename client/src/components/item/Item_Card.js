...
export default function ItemCard({ item }) {
    ...
    const handleAddToCart = () => {
        addToCart({ slug: item.slug, ...item, quantity: 1, price: item.price, stock: item.stock });
        ...
        <Card className="card-container">
            ...
            <Card.Body>
                ...
                <div className="card-actions">
                    <BootstrapButton variant="primary" onClick={handleViewDetails} className="view-details-button">
                        View Details
                    </BootstrapButton>
                    {item.stock > 0 && (
                        <button
